...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="/WEB-INF/menu.jsp">
    ...
    <c:choose>
      ...
      <c:when test="${topRole eq NULL}">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item"> <a class='nav-link <c:if test="${activeListShoes eq true}">active</c:if>' aria-current="page" href="listShoes">Список книг</a> </li>
        </ul>
      </c:when>
    </c:choose>
